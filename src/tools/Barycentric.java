...
public class Barycentric {
	...
	/*
	 * Based on Christer Ericson's Real-Time Collision Detection Obtains: point:
	 * Vector3D, triangle: Triangle Description: It Calculate the barycentric
	 * coordenates Returns: -: double[]
	 */
